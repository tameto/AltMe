...
| 2026-02-21 | チャット体験改善実装完了: AC-5 ページネーション、AC-11 画像送信、AC-12/AC-13 マークダウンレンダリング、AC-14 コンテキストメニュー（コピー/翻訳）、AC-16 未読バッジ（Realtime + ポーリング）、AC-17 ScrollToBottom FAB、AC-18 OGPプレビュー、AC-19 翻訳機能。Codex レビュー対応: SSRF防止、Signed URL、タイムゾーン修正、XSSサニタイズ強化 | SDD チャット体験改善（20260221-chat-experience） |
