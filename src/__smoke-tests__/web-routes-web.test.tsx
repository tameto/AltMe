/**
 * M012: Web スモークテスト
 * 全 app/ 画面が Web プリセット (jsdom) でクラッシュせずレンダリングされることを検証する。
 */
import './smoke-setup';
...
describe('Web Smoke Tests — all screens render without crashing', () => {
  it.each(screens)('renders $name without crashing on web', ({ Component }) => {
    expect(() => {
